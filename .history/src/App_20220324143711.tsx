...
class Snake {
  ...
  constructor() {
    ...
    this.body = this.element.getElementsByClassName('div');
  ...
  move(l: number, r: number) {
    const body = this.element.getElementsByClassName('.snake-block');
    console.log(this.element.querySelectorAll('.snake-block'))
    console.log(body)
